...
<script>
    export default {
        ...
        methods: {
            changeRecType(value) {
                this.changeSettingsHandler('cbf', 'recType', value);
                if (this.settings.recType === 'svd') {
                    this.changeSettingsHandler('cbf', 'similarityType', null);
                }
            },
            changeSimilarityType(value) {
                this.changeSettingsHandler('cbf', 'similarityType', value);
            },
            changeSimilaritySource(value) {
                this.changeSettingsHandler('cbf', 'similaritySource', value);
            },
            changeGenre(value) {
                this.changeSettingsHandler('cbf', 'genre', value);
            },
            changeMovieType(value) {
                this.changeSettingsHandler('cbf', 'movieType', value);
            },
            changeOrderBy(value) {
                this.changeSettingsHandler('cbf', 'orderBy', value);
            }
        }
    };
</script>
